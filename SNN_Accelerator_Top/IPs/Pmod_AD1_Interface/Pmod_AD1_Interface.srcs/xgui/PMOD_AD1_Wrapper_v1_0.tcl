...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BRAM_MAX_ADDR"

}

proc update_PARAM_VALUE.BRAM_MAX_ADDR { PARAM_VALUE.BRAM_MAX_ADDR } {
	# Procedure called to update BRAM_MAX_ADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BRAM_MAX_ADDR { PARAM_VALUE.BRAM_MAX_ADDR } {
	# Procedure called to validate BRAM_MAX_ADDR
	return true
}
...
proc update_MODELPARAM_VALUE.BRAM_MAX_ADDR { MODELPARAM_VALUE.BRAM_MAX_ADDR PARAM_VALUE.BRAM_MAX_ADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BRAM_MAX_ADDR}] ${MODELPARAM_VALUE.BRAM_MAX_ADDR}
}
